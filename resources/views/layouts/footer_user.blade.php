    ...
    <div class="container">
        ...
        <script>document.getElementById("year").textContent = new Date().getFullYear();</script>
            ...
            <div class="col-lg-4 text-lg-end">
                ...
                <a class="link-light text-decoration-none" href="#popupp" style="color: white;">Terms of Use</a>
                <div id="popupp">
                    <div class="window">
                        <a href="#" class="close-button" title="Close">X</a>
                        ...
                        <p>
                            <h7>memberikan informasi yang akurat, baru dan komplit tentang diri Anda saat mengisi
                                ...
                                bertanggung jawab atas proteksi dan back up data dan atau peralatan yang digunakan</h7>
                    </div>
                </div>
            </div>
        </div>
